...
from .models import PetInstanceWithoutId, PetInstanceToCreate
from .pet_instance_use_case import getAllPetInstances, createPetInstance, deletePetInstanceById, getOnePetInstanceById, updateOnePetInstanceById
...
@router.post("/")
async def handleCreatingPetInstance(pet_instance: PetInstanceToCreate):
